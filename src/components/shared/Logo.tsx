...
export function BrandMark({ className }: { className?: string }) {
  return (
    <span className={cn("relative grid size-11 shrink-0 place-items-center", className)} aria-hidden="true">
      <span className="absolute size-8 rotate-[30deg] border-[3px] border-[#b77b2c] [clip-path:polygon(25%_0,75%_0,100%_25%,100%_75%,75%_100%,25%_100%,0_75%,0_25%)]" />
      <span className="absolute size-[1.15rem] rotate-[30deg] border-2 border-[#b77b2c] [clip-path:polygon(25%_0,75%_0,100%_25%,100%_75%,75%_100%,25%_100%,0_75%,0_25%)]" />
